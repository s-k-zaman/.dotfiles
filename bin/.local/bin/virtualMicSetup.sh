...
# 1 a virtual microphone that can be used in Zoom / Jitsi / meet etc
...
# To configure `sound control` you should install 'PulseAudio Volume Control' (assuming you have pulseadio installed)
