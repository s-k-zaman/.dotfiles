...
-- IMPORTANT: must look up that documentation yourself.
local servers = {
    -- clangd = {},
    -- gopls = {},
    -- rust_analyzer = {},
    -- tsserver = {},
    pyright = require "lspLangSettings.pyright",
    lua_ls = require "lspLangSettings.lua_ls",
}
...
-- nvim-cmp SETUP [autocomplition dialog box and snippet and suggestions through LSP and other snippet tools]
